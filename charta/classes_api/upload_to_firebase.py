# Code heavily adapted from https://github.com/RobinCheptileh/simple-firestore-import
...
def import_data(service_account_key_path, data_file, collection_name):
    try:
        ...
        for datum in data:
        	# use the "set" function to set the document name as course_id
        	# this will help us uniquely identify courses
            doc_ref.document(f'{datum}').set(data[datum])
